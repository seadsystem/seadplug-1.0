 ...
 * - Added AC current continous transfer
 * - Changed voltage and current thresholds
 *
 *
 * Concerns:
...
// Stack: 1024 //default 160
// Heap: 4096 //default 160
// Done
...
void main(void) {
	WDTCTL = WDTPW + WDTSSEL__ACLK + WDTIS_3; // Watchdog timer 60 seconds
